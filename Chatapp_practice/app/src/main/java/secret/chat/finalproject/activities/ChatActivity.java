...
import secret.chat.finalproject.adapters.ChatAdapter;
import secret.chat.finalproject.databinding.ActivityChatBinding;
import secret.chat.finalproject.models.ChatMessage;
...
public class ChatActivity extends AppCompatActivity {
    ...
    private void  checkForConversionRemotely(String senderId, String receiverId) {
        database.collection(Constants.KEY_COLLECTION_CONVERSATIONS)
                .whereEqualTo(Constants.KEY_MESSAGE, senderId)
